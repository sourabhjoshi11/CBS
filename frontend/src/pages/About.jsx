...
const VALUES = [
  { icon: '💖', title: 'Made with Heart', desc: 'Every arrangement is personal. We pour love into every petal, ribbon, and bow.' },
  { icon: '🌿', title: 'Fresh Quality', desc: 'Only premium, fresh materials sourced carefully for every creation.' },
  { icon: '✨', title: 'Your Vision', desc: 'We listen to your ideas and bring your dream gift to life, exactly as you imagine.' },
  { icon: '🤝', title: 'Trust & Care', desc: 'Hundreds of happy customers who come back again and again — that\'s our promise.' },
];
  ...
  return (
    <div className="pt-20">
      ...
      <section className="bg-gradient-to-br from-rose-50 via-pink-50 to-cream py-20 text-center petal-bg">
        ...
        <p className="font-accent text-rose-500 text-2xl">@creationsby_saloni ✨</p>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="w-full aspect-square rounded-3xl bg-gradient-to-br from-rose-100 via-pink-100 to-rose-200 flex items-center justify-center shadow-2xl shadow-rose-100 overflow-hidden">
                ...
                <div className="text-center p-8">
                  ...
                  <p className="font-accent text-rose-400 mt-2 text-lg">Handmade with love ✨</p>
            ...
            <div className="space-y-5">
              <div>
                ...
                <h2 className="font-display text-4xl font-bold text-rose-900">Saloni 🌸</h2>
              </div>
              ...
              <p className="text-gray-600 font-body leading-relaxed">
                Whether it's your partner's anniversary, your best friend's birthday, or a festive celebration — I'm here to make it magical. No two creations are ever the same. ✨
              </p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-3xl p-8 shadow-lg shadow-rose-50 border border-rose-100">
              ...
              <h3 className="font-display text-2xl font-bold text-rose-900 mb-3">Our Mission 💖</h3>
              <p className="text-gray-600 font-body leading-relaxed">
      ...
      <section className="py-16 bg-gradient-to-br from-rose-900 to-pink-900 text-white text-center">
        <div className="max-w-xl mx-auto px-6">
          ...
          <p className="text-rose-200 font-body mb-6">Let Saloni handcraft something magical just for you and your loved ones. 🌸</p>
